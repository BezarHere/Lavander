...
This script allows the creation of very BIG numbers, like those you see in idle games. It supports formating to AA-notation like 2.00M, 4.56AA or even bigger numbers.

Make sure to get the latest version from Github.

Githup: https://github.com/ChronoDK/GodotBigNumberClass
